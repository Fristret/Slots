...
//  }
//
//  def checkWin(screen: Screen, login: Login, bet: Bet, rpgProgress: Ref[IO, Map[Login, Stage]]): IO[Win] = {
//    val payment = winingMap(screen, bet)
//    val listWithWin = payment.keys.toList
//    val listRPGAction = getElements(listWithWin)
//    for {
//      rewardsRPG <- playRPG(listRPGAction, login, bet, rpgProgress)
...
//    checkWin(screen, login, bet, rpgProgress)
//  }
//}
