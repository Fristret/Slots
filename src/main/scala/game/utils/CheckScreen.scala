...
import game.models.SlotObjects.{Column, Symbol}
import game.utils.SaveMethods._

object CheckScreen {

  // 1 -> 1 -> 1 -> 1 -> 1
  def checkRow(int: Int, count: Int = 1, list: List[Column]): List[Symbol] = count match {
    case 5 => List(getHead(int, list))
    case _ => List(getHead(int, list)) ++ checkRow(int, count + 1, list.tailSave)
  }

  //1 -> 2 -> 1 -> 2 -> 1 || 1 -> 2 -> 1 -> 2 -> 3
  def check2(end: Int, count: Int = 1, list: List[Column]): List[Symbol] = count match {
  ...
  // 1 -> 3 -> 1 -> 3 -> 1
  def check3(int: Int, count: Int = 1, list: List[Column]): List[Symbol] = count match {
    case 5 => List(getHead(int, list))
    case _ => int match {
  ...
  //1 -> 3 -> 3 -> 3 -> 1 || 3 -> 2 -> 2 -> 2 -> 3
  def check4(int: Int, count: Int = 1, list: List[Column]): List[Symbol] = count match {
    case 5 => List(getHead(int, list))
  ...
  // 3 -> 2 -> 1 -> 2 -> 3
  def check5(count: Int = 1, list: List[Column]): List[Symbol] = count match {
  ...
  //1 -> 2 -> 2 -> 2 -> 3
  def check6(int: Int, count: Int = 1, list: List[Column]): List[Symbol] = count match {
    case 1 => int match {
  ...
  // 3 -> 3 -> 1 -> 3 -> 3 || 2 -> 3 -> 1 -> 3 -> 2
  def check7(int: Int, count: Int = 1, list: List[Column]): List[Symbol] = count match {
    case 5 => List(getHead(int, list))
  ...
  //1 -> 3 -> 2 -> 3 -> 2
  def check8(count: Int = 1, list: List[Column]): List[Symbol] = count match {
